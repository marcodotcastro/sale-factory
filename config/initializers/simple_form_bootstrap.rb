...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-md-6 col-sm-6 col-xs-12' do |bb|
      bb.use :input, class: 'form-control col-md-7 col-xs-12', error_class: 'is-invalid', valid_class: 'is-valid'
