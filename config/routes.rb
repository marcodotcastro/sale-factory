...
#         industria_dashboards_mapa_solicitacoes GET        /industrias/:industria_id/dashboards/mapa/solicitacoes(.:format)                              industrias/dashboards#mapa_solicitacoes
#                     industria_dashboards_geral GET        /industrias/:industria_id/dashboards/geral(.:format)                                          industrias/dashboards#geral
# industria_dashboards_performance_representante GET        /industrias/:industria_id/dashboards/performance/representante(.:format)                      industrias/dashboards#performance_representante
#       industria_dashboards_performance_lojista GET        /industrias/:industria_id/dashboards/performance/lojista(.:format)                            industrias/dashboards#performance_lojista
#       industria_dashboards_performance_produto GET        /industrias/:industria_id/dashboards/performance/produto(.:format)                            industrias/dashboards#performance_produto
...
#     representante_dashboards_mapa_solicitacoes GET        /representantes/:representante_id/dashboards/mapa/solicitacoes(.:format)                      representantes/dashboards#mapa_solicitacoes
...
#   representante_dashboards_performance_lojista GET        /representantes/:representante_id/dashboards/performance/lojista(.:format)                    representantes/dashboards#performance_lojista
#   representante_dashboards_performance_produto GET        /representantes/:representante_id/dashboards/performance/produto(.:format)                    representantes/dashboards#performance_produto
...
Rails.application.routes.draw do
  ...
  resources :industrias do
    scope module: :industrias do
      ...
      get "dashboards/performance/representante", to: "dashboards#performance_representante"
      get "dashboards/performance/lojista", to: "dashboards#performance_lojista"
      get "dashboards/performance/produto", to: "dashboards#performance_produto"
