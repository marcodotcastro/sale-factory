...
# cliente_representante_lojista_service_area_lojistas GET    /clientes/:cliente_id/representantes/:representante_id/lojistas/:lojista_id/service_area/lojistas(.:format) clientes/representantes/lojistas#service_area
#                      cliente_representante_lojistas GET    /clientes/:cliente_id/representantes/:representante_id/lojistas(.:format)                                   clientes/representantes/lojistas#index
#                                                     POST   /clientes/:cliente_id/representantes/:representante_id/lojistas(.:format)                                   clientes/representantes/lojistas#create
#                   new_cliente_representante_lojista GET    /clientes/:cliente_id/representantes/:representante_id/lojistas/new(.:format)                               clientes/representantes/lojistas#new
#                  edit_cliente_representante_lojista GET    /clientes/:cliente_id/representantes/:representante_id/lojistas/:id/edit(.:format)                          clientes/representantes/lojistas#edit
#                       cliente_representante_lojista GET    /clientes/:cliente_id/representantes/:representante_id/lojistas/:id(.:format)                               clientes/representantes/lojistas#show
#                                                     PATCH  /clientes/:cliente_id/representantes/:representante_id/lojistas/:id(.:format)                               clientes/representantes/lojistas#update
#                                                     PUT    /clientes/:cliente_id/representantes/:representante_id/lojistas/:id(.:format)                               clientes/representantes/lojistas#update
#                                                     DELETE /clientes/:cliente_id/representantes/:representante_id/lojistas/:id(.:format)                               clientes/representantes/lojistas#destroy
...
#           representante_service_area_representantes GET    /representantes/:representante_id/service_area/representantes(.:format)                                     representantes#service_area
#         representante_lojista_service_area_lojistas GET    /representantes/:representante_id/lojistas/:lojista_id/service_area/lojistas(.:format)                      representantes/lojistas#service_area
