class Clientes::ComentariosController < ApplicationController
  before_action :set_cliente, only: [:show, :new, :create]
  ...
  def create
    ...
    respond_to do |format|
      if @comentario.save!
        format.html {redirect_to cliente_solicitacao_path(@cliente, @solicitacao), flash: {success: 'Comentario foi criado com sucesso.'}}
      else
